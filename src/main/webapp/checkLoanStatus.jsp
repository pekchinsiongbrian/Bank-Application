...
<body>
	<h1>Here is the list of loans you have taken:</h1>
	<table>
		<tr>
			<th>S/N</th>
			<th>Loan Amount</th>
	...
	<br>
	<h1>Here is the list of loans that are still pending approval:</h1>
	<table>
		<tr>
			<th>S/N</th>
			<th>Loan Amount</th>
		...
		<%
			ArrayList<LoanModel> pendingLoanList = (ArrayList<LoanModel>) session.getAttribute("pendingLoanList");
	...
	<h4>Click <a href="/bankservicesystem/customer.jsp">here</a> to return to home page</h4>
</body>
</html>